...
namespace App.Controllers
{
    ...
    public class BlogController : Controller
    {
        ...
        static readonly string _listView = "~/Areas/Blog/Views/Themes/{0}/List.cshtml";
        ...
        public async Task<IActionResult> Single(string slug)
        {
            try
            {
                ...
                return View($"~/Areas/Blog/Views/Themes/{model.Blog.Theme}/Post.cshtml", model);
            }
            catch
            {
        ...
        public async Task<IActionResult> Error(int code)
        {
            ...
            var viewName = $"~/Areas/Blog/Views/Themes/{model.Blog.Theme}/Error.cshtml";
            ...
            {
                return View("~/Areas/Blog/Views/Shared/_Error.cshtml", model);
            }
        }
